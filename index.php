    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
		...
		<br>
			...
			<div class="row">
				...
				<div class="modal fade" id="githubModal" tabindex="-1" role="dialog" aria-labelledby="githubModal" aria-hidden="true">
      ...
      <div class="modal fade" id="myModal3" tabindex="-1" role="dialog" aria-labelledby="myModal3" aria-hidden="true">
		...
		<div class="container" id="contact">
			<div class="row">
			<br>
				<h1 class="centered">GRACIAS POR VISITARME</h1>
				<hr>
				<br>
            ...
            <form role="form" action="<?php echo $_SERVER["PHP_SELF"]; ?>" method="post" >
                ...
                <span itemprop="sender">
      					...
      					<div class="form-group">
      						...
      						<div class="input-group">
      							<textarea name="message" id="message" class="form-control" rows="5" placeholder="Hola! ..." required></textarea>
      							<span class="input-group-addon"><i class="glyphicon glyphicon-ok form-control-feedback"></i></span>
      						</div>
      					</div>
